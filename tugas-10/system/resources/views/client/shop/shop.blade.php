        ...
        <div class="amado_product_area section-padding-100">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <!-- Single Product Area -->
                    <div class="col-12 col-sm-4 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <img src="{{ url('public') }}/assets/img/product-img/product6.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="{{ url('public') }}/assets/img/product-img/product1.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="ratings-cart text-right">
                                    ...
                                    <div class="cart">
                                        <a href="cart.html" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="{{ url('public') }}/assets/img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                    ...
                    <div class="col-12 col-sm-4 col-md-10 col-xl-6">
                        <div class="single-product-wrapper">
                            @foreach($list_produk as $produk) 
