...
<body>
    ...
    <section class="hero-slider">
        <div class="hero-items owl-carousel">
            <div class="single-slider-item set-bg" data-setbg="{{ url('public') }}/assets/img/slider-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2019</h1>
            ...
            <div class="single-slider-item set-bg" data-setbg="{{ url('public') }}/assets/img/slider-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2019</h1>
            ...
            <div class="single-slider-item set-bg" data-setbg="{{ url('public') }}/assets/img/slider-3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2019</h1>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-features-ads first">
                            <img src="{{ url('public') }}/assets/img/icons/f-delivery.png" alt="">
                            <h4>Free shipping</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="single-features-ads second">
                            <img src="{{ url('public') }}/assets/img/icons/coin.png" alt="">
                    ...
                    <div class="col-lg-4">
                        <div class="single-features-ads">
                            <img src="{{ url('public') }}/assets/img/icons/chat.png" alt="">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="single-box-item first-box">
                                    <img src="{{ url('public') }}/assets/img/f-box-1.jpg" alt="">
                                    <div class="box-text">
                            ...
                            <div class="col-lg-12">
                                <div class="single-box-item second-box">
                                    <img src="{{ url('public') }}/assets/img/f-box-2.jpg" alt="">
                                    <div class="box-text">
                    ...
                    <div class="col-lg-6">
                        <div class="single-box-item large-box">
                            <img src="{{ url('public') }}/assets/img/f-box-3.jpg" alt="">
                            <div class="box-text">
                                <span class="trend-year">2019 Party</span>
                                <h2>Collection</h2>
            ...
            <div class="row" id="product-list">
                <div class="col-lg-3 col-sm-6 mix all dresses bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/assets/img/products/img-1.jpg" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6 mix all dresses bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/assets/img/products/img-2.jpg" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6 mix all shoes accesories">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/assets/img/products/img-3.jpg" alt=""></a>
                            <div class="p-status">new</div>
                        </figure>
                        <div class="product-text">
                ...
                <div class="col-lg-3 col-sm-6 mix all shoes accesories">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/assets/img/products/img-4.jpg" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6 mix all dresses shoes">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/assets/img/products/img-5.jpg" alt=""></a>
                            <div class="p-status">new</div>
                        </figure>
                        <div class="product-text">
                            <h6>Green Dress with details</h6>
                ...
                <div class="col-lg-3 col-sm-6 mix all accesories bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/assets/img/products/img-6.jpg" alt=""></a>
                            <div class="p-status sale">sale</div>
                        </figure>
                        <div class="product-text">
                            <h6>Yellow Maxi Dress</h6>
                ...
                <div class="col-lg-3 col-sm-6 mix all dresses bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/assets/img/products/img-7.jpg" alt=""></a>
                        </figure>
                        <div class="product-text">
                            <h6>One piece bodysuit</h6>
                            <p>$19.90</p>
                ...
                <div class="col-lg-3 col-sm-6 mix all accesories bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/assets/img/products/img-8.jpg" alt=""></a>
                            <div class="p-status popular">popular</div>
                        </figure>
                        <div class="product-text">
                            <h6>Blue Dress with details</h6>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="lookbok-pic">
                        <img src="{{ url('public') }}/assets/img/lookbok.jpg" alt="">
    ...
    <div class="logo-section spad">
        <div class="logo-items owl-carousel">
            <div class="logo-item">
                <img src="{{ url('public') }}/assets/img/logos/logo-1.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{ url('public') }}/assets/img/logos/logo-2.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{ url('public') }}/assets/img/logos/logo-3.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{ url('public') }}/assets/img/logos/logo-4.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{ url('public') }}/assets/img/logos/logo-5.png" alt="">
            </div>
        </div>
    </div>
    <!-- Logo Section End -->
