                    ...
                    <ul>
                        ...
                        <li><a href="{{ url('/categories') }}">Shop</a>
                            <ul class="sub-menu">
                                ...
                                <li><a class="active" href="{{ url('/check-out') }}">Check out</a></li>
                            </ul>
                        </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="payment-method">
                            <h3>Payment</h3>
                            <ul>
                                <li>Paypal <img src="{{ url('public') }}/assets/img/paypal.jpg" alt=""></li>
                                <li>Credit / Debit card <img src="{{ url('public') }}/assets/img/mastercard.jpg" alt=""></li>
                                <li>
