        ...
        <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                ...
                @if(Auth::check())
                    ...
                    @else
                        <h2 class="col-md-12 d-flex align-items-center">Silahkan Login</h2>
                    @endif
                    ...
                    @include('admin.template.utils.notif')
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="{{url('home')}}" class="">
                                <h3 class="text-primary">Violet</h3>
                            </a>
                            <h3>Sign In</h3>
                        </div>
                        ...
                        <a href="{{url('admin/beranda')}}"><button type="submit" class="btn btn-primary py-3 w-100 mb-4">sign in</button></a>
