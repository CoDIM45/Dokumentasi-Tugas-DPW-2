                                ...
                                <tbody>
                                    <tr>
                                        <td class="cart_product_img">
                                            <a href="#"><img src="{{ url('public') }}/assets/img/bg-img/cart1.jpg" alt="Product"></a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="cart_product_img">
                                            <a href="#"><img src="{{ url('public') }}/assets/img/bg-img/cart2.jpg" alt="Product"></a>
                                        </td>
                                        <td class="cart_product_desc">
                                    ...
                                    <tr>
                                        <td class="cart_product_img">
                                            <a href="#"><img src="{{ url('public') }}/assets/img/bg-img/cart3.jpg" alt="Product"></a>
                                        </td>
                                        <td class="cart_product_desc">
                                            <h5>Minimal Plant Pot</h5>
                                        </td>
